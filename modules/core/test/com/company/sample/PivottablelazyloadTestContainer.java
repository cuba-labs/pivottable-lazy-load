...
public class PivottablelazyloadTestContainer extends TestContainer {

    public PivottablelazyloadTestContainer() {
        super();
    ...
    public static class Common extends PivottablelazyloadTestContainer {

        public static final PivottablelazyloadTestContainer.Common INSTANCE = new PivottablelazyloadTestContainer.Common();
